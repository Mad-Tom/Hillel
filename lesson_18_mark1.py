...
# ЭТАП 1
# преобразование изображений с лицами в массивы данных, которые нейронные сети считают важными
# лица идентифицируются и вырезаются из общего фона
# результат в виде матриц с числами сохраняется в файл
...
for (i, imagePath) in enumerate(imagePaths):
  ...
  print("[INFO] processing image {}/{}".format(i + 1,
    len(imagePaths)))
  name = imagePath.split(os.path.sep)[-2]; print(name)
